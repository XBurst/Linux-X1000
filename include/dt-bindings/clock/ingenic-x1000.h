...
#define	CLK_RTC			(CLK_ID_FIEXED + 1)
...
#define CLK_CGU_MSC0		(CLK_ID_DIV + 4)
#define CLK_CGU_MSC1		(CLK_ID_DIV + 5)
#define CLK_CGU_USB		(CLK_ID_DIV + 6)
...
#define NR_CLKS		(CLK_NR_FIXED + CLK_NR_PLL + CLK_NR_CPCCR + CLK_NR_CGU + CLK_NR_GATE + CLK_NR_PWC)
#endif	/* _DT_BINDINGS_CLOCK_X1000_H */
