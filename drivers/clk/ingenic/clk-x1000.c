...
static struct ingenic_pll_hwdesc apll_hwdesc = \
	PLL_DESC(CPM_CPAPCR, 24, 7, 18, 5, 16, 2, 8, 10, 31, pll_od_encode, NULL);

static struct ingenic_pll_hwdesc mpll_hwdesc = \
	PLL_DESC(CPM_CPMPCR, 24, 7, 18, 5, 16, 2, 7, 0, 31, pll_od_encode, NULL);
...
static const struct ingenic_clk_init __initdata x1000_clk_init_data[] = {
	...
	X1000_CLK_INIT_LOCKED(CLK_CGU_MAC, cgu_sel_grp0, &ingenic_cgu_ops, CLK_SET_RATE_GATE|CLK_SET_PARENT_GATE,
			&cgu_hwdesc[1]),
	X1000_CLK_INIT_LOCKED(CLK_CGU_LCD, cgu_sel_grp0, &ingenic_cgu_ops, CLK_SET_RATE_GATE|CLK_SET_PARENT_GATE,
			&cgu_hwdesc[2]),
	X1000_CLK_INIT_LOCKED(CLK_CGU_MSC0, cgu_sel_grp0, &ingenic_cgu_ops, CLK_SET_RATE_GATE|CLK_SET_PARENT_GATE,
			&cgu_hwdesc[3]),
	X1000_CLK_INIT_LOCKED(CLK_CGU_MSC1, cgu_sel_grp0, &ingenic_msc1_ro_ops, CLK_GET_RATE_NOCACHE,
			&cgu_hwdesc[4]),
	X1000_CLK_INIT_LOCKED(CLK_CGU_USB, cgu_usb, &ingenic_cgu_ops, CLK_SET_RATE_GATE|CLK_SET_PARENT_GATE,
			&cgu_hwdesc[5]),
	X1000_CLK_INIT_LOCKED(CLK_CGU_SFC, cgu_sel_grp0, &ingenic_cgu_ops, CLK_SET_RATE_GATE|CLK_SET_PARENT_GATE,
			&cgu_hwdesc[6]),
	X1000_CLK_INIT_LOCKED(CLK_CGU_CIM, cgu_sel_grp0, &ingenic_cgu_ops, CLK_SET_RATE_GATE|CLK_SET_PARENT_GATE,
			&cgu_hwdesc[7]),
