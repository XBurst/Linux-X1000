...
static const struct ingenic_cgu_clk_info x1000_cgu_clocks[] = {
	...
	[X1000_CLK_L2CACHE] = {
		"l2cache", CGU_CLK_DIV,
		.parents = { X1000_CLK_CPUMUX, -1, -1, -1 },
		.div = { CGU_REG_CPCCR, 4, 1, 4, 22, -1, -1 },//22是否应改为-1？
	},
	...
	[X1000_CLK_MAC] = {
		...
		.div = { CGU_REG_MACPHYCDR, 0, 1, 8, 29, 28, 27 },
	...
	[X1000_CLK_SSIMUX] = {
		"ssi_mux", CGU_CLK_MUX,
		.parents = { X1000_CLK_EXCLK, X1000_CLK_SSIPLL, -1, -1 },//SSI实际时钟来源为EXCLK或SSIPLL/2，当前设置不确定是否有问题
