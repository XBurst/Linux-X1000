...
static struct ingenic_nand_base_param winbond_param[WINBOND_DEVICES_NUM] = {
	[0] = {
		/*W25N01GV*/
		.pagesize = 2 * 1024,
		.blocksize = 2 * 1024 * 64,
...
int __init winbond_nand_init(void) {
	struct ingenic_nand_device *winbond_nand;
	...
	return ingenic_nand_register(winbond_nand);
}
